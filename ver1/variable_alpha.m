...
%% 결과 그래프 그리기
figure;
plot(alpha_values, true_probability, '-o', 'DisplayName', '탐지 확률 (P_d)');
hold on;
plot(alpha_values, false_probability, '-x', 'DisplayName', '오탐지 확률 (P_f)');
