...
figure(1);
hold on;
plot(N_values, true_probability, '-yo', 'DisplayName', '탐지 확률 (P_d)');
hold on;
% plot(N_values, false_probability, '-x', 'DisplayName', 'false_alarm(P_f');
xlabel('N_(values)');
ylabel('Probability');
legend show;
