...
figure(1);
hold on;
%plot(SNR_dB, false_probability, '-rx', 'DisplayName', 'false alarm (P_f)');


%plot(SNR_dB, true_probability, '-bo', 'DisplayName', 'N=4 탐지 확률 (P_d)');
%plot(SNR_dB, true_probability, '-go', 'DisplayName', 'N=32 탐지 확률 (P_d)');
plot(SNR_dB, true_probability, '-ko', 'DisplayName', 'N=128 탐지 확률 (P_d)');
